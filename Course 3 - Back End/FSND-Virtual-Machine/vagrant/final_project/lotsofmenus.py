...
restaurant2 = Restaurant(name = "Super Stir Fry", description = "Taking your Stir Fry and making it SUPER!")
...
restaurant1 = Restaurant(name = "Panda Garden", description = "Home of the finest chinese cuisine.")
...
restaurant1 = Restaurant(name = "Thyme for That Vegetarian Cuisine ", description = "A common congrating place for herbivores.")
...
restaurant1 = Restaurant(name = "Tony\'s Bistro ", description = "It's definitely italian food.")
...
#Menu for Andala's
restaurant1 = Restaurant(name = "Andala\'s", description = "The best curries in town.")
...
restaurant1 = Restaurant(name = "Auntie Ann\'s Diner' ", description = "Good ol'fashioned eats. Food made the way it should be.")
...
restaurant1 = Restaurant(name = "Cocina Y Amor ", description = "Your finest mexican eats.")
